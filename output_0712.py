...
# # Merge the plots into a single HTML file
# from plotly.subplots import make_subplots

# fig_combined = make_subplots(rows=2, cols=2, subplot_titles=("聽覺評價雷達圖", "視覺評價雷達圖", "言語內容評分"))

# fig_combined.add_trace(fig_auditory.data[0], row=1, col=1)
# fig_combined.add_trace(fig_visual.data[0], row=1, col=2)
# fig_combined.add_trace(fig_verbal.data[0], row=2, col=1)

# fig_combined.update_layout(height=800, width=800, title_text="面試評估結果")
# fig_combined.show()
